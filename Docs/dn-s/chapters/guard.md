...
# Chapter 6 — Guard and the ID-Checking System Inside You

Guard is *a careful-macrophage-tween (chunky-cartoon checking-pose) in chunky-cartoon lab-tunic with a small immune-cell-cards + ID-checking-tracker.*
...
Guard says: *"I am Guard. The primitive I teach is *immune cells.* The move is *I check IDs; patient + careful; innate + adaptive layers; vaccines train the system.*"*
