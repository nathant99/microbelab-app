...
app: microbelab
primitive: NET — *forests talk through me.*
audience: ages 9-14
...
# Chapter 4 — Net and the Wood-Wide-Web Underneath the Forest

Net is *a thread-spreading-mycelium-tween (chunky-cartoon network-extending-pose) in chunky-cartoon lab-tunic with a small mycorrhizal-cards + nitrogen-fixation-tracker.*
...
Net says: *"I am Net. The primitive I teach is *mycorrhizal fungi + N-fixers.* The move is *forests talk through me; underground networks.*"*
