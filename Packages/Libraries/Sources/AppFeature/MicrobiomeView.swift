...
/// (microbiome stability milestone per `Docs/FEATURE_PLAN.md` line 91).
public struct MicrobiomeView: View {
    ...
    public init(simulator: MicrobiomeSimulator, mentor: VeeMentor? = nil) {
            ...
            HStack(spacing: 12) {
                Button("Tick") {
                    ...
                    if tickCount > 0, tickCount % 5 == 0 {
                        ...
                        DebugLog.state("MicrobiomeView milestone tick=\(tickCount)")
                    }
                }
